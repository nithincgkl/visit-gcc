...
const Tabs = () => { 
    ...
    const countryDataThree = [
        ...
        },
        {
            ...
            subHeading: 'Journey Through Time',
            description: 'Treat yourself to Luqaimat, delightful sweet dumplings drenched in date syrup. These golden, syrupy bites are a beloved part of Qatari dessert traditions, offering a perfect balance of sweetness and texture that captures the essence of local culinary delights.',
            image: "/images/country/02.jpg"
        },
        {
            id: 3,
    ...
    const countryDataFour = [
        ...
        },
        {
            ...
            subHeading: 'Journey Through Time',
            description: 'Discover the vibrant atmosphere of Souq Waqif, where traditional Qatari crafts, spices, and textiles are on display. This bustling market offers a rich sensory experience and a chance to find unique, handcrafted souvenirs that capture the essence of Qatar\'s rich trading history.',
            image: "/images/country/02.jpg"
        },
        {
            id: 3,
